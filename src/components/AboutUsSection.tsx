        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center">
            ...
            <div className="bg-white rounded-xl p-8 border border-gray-200">
              <p className="text-gray-500">Loading board member data from Sanity...</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="container-custom">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 lg:gap-12">
          {boardMembers.map((member) => (
            <div key={member._id} className="card-elevated overflow-hidden group hover:scale-105 transform transition-all duration-300">
              {/* Profile Image */}
              ...
              <div className="p-6 lg:p-8">
                <h3 className="font-heading font-bold text-xl text-gsu-blue-800 mb-2 leading-tight">
                  {member.name}
                </h3>
                
                <p className="text-gsu-gold-600 font-semibold text-lg mb-2">
                ...
                <div className="flex space-x-3">
                  <a 
                    ...
                    className="flex-1 bg-gsu-blue-100 text-gsu-blue-700 px-4 py-3 rounded-lg font-semibold hover:bg-gsu-blue-200 transition-all duration-200 flex items-center justify-center shadow-soft hover:shadow-medium"
                  >
                  ...
                  {member.linkedin && (
                    <a 
                      ...
                      className="bg-gsu-gold-100 text-gsu-gold-700 px-4 py-3 rounded-lg font-semibold hover:bg-gsu-gold-200 transition-all duration-200 flex items-center justify-center shadow-soft hover:shadow-medium"
                    >
